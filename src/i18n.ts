...
const en = {
  ...
  gatesSaving: "Saving gates…",
  gatesSaved: "Delivery gates saved",
  gatesSaveFailed: "Delivery gates were not saved. Your input is preserved; please retry.",
  gatesRefreshFailed: "Delivery gates were saved, but the view could not be refreshed. Refresh the view to see the latest state.",
...
const zh: typeof en = {
  ...
  gatesSaving: "正在保存门禁…",
  gatesSaved: "交付门禁已保存",
  gatesSaveFailed: "交付门禁保存失败，已保留输入，请重试。",
  gatesRefreshFailed: "交付门禁已保存，但界面刷新失败，请刷新视图查看最新状态。",
