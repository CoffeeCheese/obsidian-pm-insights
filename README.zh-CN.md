...
选择成员后，点击姓名旁的仪表按钮即可打开居中的**个人交付简报**。这个弹窗聚焦一个关键判断：这个人当前承担的项目工作，能否在各项目交付日前装入剩余工时容量？

![使用中文虚构测试数据的个人交付简报，展示交付窗口、项目工作负载和逐项目累计的交付容量缺口](docs/assets/pm-insights-member-dashboard-focused.zh-CN.png)

*截图仅使用“个人仪表盘演示”虚构项目与模拟成员。容量轨道上的刻度表示可用容量上限，斜纹段表示交付日前无法装下的超载工时。*
